...
NotebookDataLength[     22504,        628]
NotebookOptionsPosition[     19878,        533]
NotebookOutlinePosition[     21494,        584]
CellTagsIndexPosition[     21174,        572]
WindowFrame->Normal*)
...
CellTagsIndex->{
 "ResizeImages"->{
  Cell[13932, 364, 312, 8, 30, "ControlSuggestions",
   CellTags->"ResizeImages"]},
 "RotateAndZoomIn3D"->{
  Cell[14247, 374, 678, 16, 30, "ControlSuggestions",
   CellTags->"RotateAndZoomIn3D"]},
 "DragLocators"->{
  Cell[14928, 392, 340, 11, 30, "ControlSuggestions",
   CellTags->"DragLocators"]},
 "CreateAndDeleteLocators"->{
  Cell[15271, 405, 637, 15, 30, "ControlSuggestions",
   CellTags->"CreateAndDeleteLocators"]},
 "SliderZoom"->{
  Cell[15911, 422, 844, 21, 30, "ControlSuggestions",
   CellTags->"SliderZoom"]},
 "GamepadControls"->{
  Cell[16758, 445, 369, 9, 30, "ControlSuggestions",
   CellTags->"GamepadControls"]},
 "AutomaticAnimation"->{
  Cell[17130, 456, 1464, 31, 30, "ControlSuggestions",
   CellTags->"AutomaticAnimation"]},
 "BookmarkAnimation"->{
  Cell[18597, 489, 908, 21, 30, "ControlSuggestions",
   CellTags->"BookmarkAnimation"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ResizeImages", 20283, 545},
 {"RotateAndZoomIn3D", 20391, 548},
 {"DragLocators", 20500, 551},
 {"CreateAndDeleteLocators", 20615, 554},
 {"SliderZoom", 20728, 557},
 {"GamepadControls", 20833, 560},
 {"AutomaticAnimation", 20945, 563},
 {"BookmarkAnimation", 21061, 566}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[1737, 45, 8510, 193, 289, "Input"],
Cell[10250, 240, 113, 2, 30, "Input",
 CellID->34685211]
}, Open  ]],
Cell[CellGroupData[{
Cell[10400, 247, 36, 0, 202, "ManipulateCaptionSection"],
Cell[10439, 249, 33, 0, 26, "ManipulateCaption"]
}, Open  ]],
Cell[CellGroupData[{
Cell[10509, 254, 28, 0, 206, "ThumbnailSection"],
Cell[10540, 256, 1242, 34, 278, "Output"]
}, Open  ]],
Cell[CellGroupData[{
Cell[11819, 295, 28, 0, 226, "SnapshotsSection"],
Cell[11850, 297, 1241, 34, 335, "Output"]
}, Open  ]],
Cell[CellGroupData[{
Cell[13128, 336, 26, 0, 488, "DetailsSection"],
Cell[13157, 338, 270, 5, 30, "DetailNotes",
 CellID->141046904],
Cell[13430, 345, 216, 5, 30, "DetailNotes",
 CellID->18807664],
Cell[13649, 352, 206, 5, 30, "DetailNotes",
 CellID->59157874]
}, Open  ]],
Cell[CellGroupData[{
Cell[13892, 362, 37, 0, 182, "ControlSuggestionsSection"],
Cell[13932, 364, 312, 8, 30, "ControlSuggestions",
 CellTags->"ResizeImages"],
Cell[14247, 374, 678, 16, 30, "ControlSuggestions",
 CellTags->"RotateAndZoomIn3D"],
...
Cell[19520, 513, 30, 0, 227, "SearchTermsSection"],
Cell[CellGroupData[{
Cell[19575, 517, 31, 0, 182, "RelatedLinksSection"],
Cell[19609, 519, 138, 3, 30, "RelatedLinks",
 CellID->367933451]
}, Open  ]],
Cell[CellGroupData[{
Cell[19784, 527, 25, 0, 202, "AuthorSection"],
Cell[19812, 529, 38, 0, 30, "Author"]
}, Open  ]]
}, Open  ]]
}
]
...
(* NotebookSignature QvpCPuLDTJm8NAgwLUbizt3r *)
